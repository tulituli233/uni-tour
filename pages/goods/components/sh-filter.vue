	...
	<view class="filter-box">
		...
		<view class="navbar">
			...
			<view class="nav-item u-flex-col" :class="{ current: filterIndex === 1 }" @tap="tabClick(1)">
				<view class="title-box u-flex"><text class="filter-title">民宿</text></view>
			...
			<view class="nav-item u-flex-col" :class="{ current: filterIndex === 2 }" @tap="tabClick(2)">
				<view class="title-box u-flex"><text class="filter-title">餐饮</text></view>
			...
			<view class="nav-item u-flex-col" :class="{ current: filterIndex === 3 }" @tap="tabClick(3)">
				<view class="title-box"><text class="filter-title">景点</text></view>
			...
			<view class="nav-item u-flex-col" :class="{ current: filterIndex === 4 }" @tap="tabClick(4)">
				<view class="title-box u-flex">
					<text class="filter-title">跟团</text>
	...
	export default {
		...
		methods: {
			...
			tabClick(index) {
				...
				// index === 2 ? (this.salesOrder = 1) : (this.salesOrder = 0);
				// index === 3 ? (this.priceOrder = this.priceOrder === 1 ? 2 : 1) : (this.priceOrder = 0);
				// index === 4 ? (this.newProdcutOrder = 1) : (this.newProdcutOrder = 0);
