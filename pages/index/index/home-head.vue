	...
	<view class="banner-swiper-wrap u-m-b-10">
		...
		<view class="u-navbar u-navbar-fixed" :style="[navbarStyle]">
			...
			<view class="u-navbar-inner" :style="[navbarInnerStyle]">
				<!-- LOGO -->
				<view hover-class="hover-test" class="u-back-wrap">
		...
		<!-- 轮播组件 -->
		<swiper class="screen-swiper square-dot" @change="onChange" style="height: 520rpx" :indicator-dots="true"
